    ...
    Tab(
        ...
        text = {
            ...
            ProvideTextStyle(
                value = style,
                content = {
                    Box(modifier = Modifier.padding(top = SchoolxTabDefaults.TabTopPadding)) {
                        text()
                    }
                },
            )
 ...
 * @param tabs The tabs inside this tab row. Typically this will be multiple [SchoolxTab]s. Each element
